...
class ImportMid1Dialog extends StatefulWidget {
  final MidSession midSession;
  final VoidCallback onImportComplete;

  const ImportMid1Dialog({
    Key? key,
  ...
  @override
  State<ImportMid1Dialog> createState() => _ImportMid1DialogState();
}

class _ImportMid1DialogState extends State<ImportMid1Dialog> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Import Mid 1 marks from an Excel file. The file should have the following columns:\n'
              '• Student ID\n'
              '• Name\n'
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            try {
              await _importService.saveImportedMid1Marks(
              ...
              if (mounted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Mid 1 marks imported successfully')),
                );
              }
            } catch (e) {
              setState(() {
    ...
    return Column(
      children: [
        ElevatedButton(
          ...
          onPressed: () async {
            try {
              final marks = await _importService.importMid1MarksFromExcel(context);
              setState(() {
