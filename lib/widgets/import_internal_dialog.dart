...
import 'package:markpro_plus/services/internal_import_service.dart';

class ImportInternalDialog extends StatefulWidget {
  final LabSession labSession;
  final Function onImportComplete;

  const ImportInternalDialog({
    Key? key,
  ...
  @override
  State<ImportInternalDialog> createState() => _ImportInternalDialogState();
}

class _ImportInternalDialogState extends State<ImportInternalDialog> {
  final InternalImportService _importService = InternalImportService();
                    ...
                    ElevatedButton(
                      onPressed: _isImporting
                          ...
                          : () async {
                              ...
                              try {
                                final importedMarks =
                                    await _importService.importInternalMarksFromExcel(context);
                    ...
                    ElevatedButton(
                      onPressed: _importedMarks.isEmpty || _isImporting
                          ...
                          : () async {
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 20),
                                          Text('Importing ${_importedMarks.length} internal marks...')
                                        ],
                                      ),
                                    ),
                                  );
                              ...
                              try {
                                await _importService.saveImportedInternalMarks(
                                    ...
                                    SnackBar(
                                      content: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              'Successfully imported ${_importedMarks.length} internal marks',
        ...
        children: [
          ...
          _buildInstructionItem(
            ...
            subItems: [
              'Student ID (required)',
              'Name (required)',
              'Internal 1 (required, 0-15)',
              'Internal 2 (required, 0-15)',
            ],
          ),
          _buildInstructionItem(
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                ...
                const TextSpan(
                  text: 'Existing internal marks will be overwritten for the imported students.',
                ),
              ],
            ),
          ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      'Internal 1: ${mark['internal1']} | Internal 2: ${mark['internal2']}',
                    ),
                    leading: CircleAvatar(
                      backgroundColor: Colors.green.shade100,
                      child: Text(
                        ((mark['internal1'] + mark['internal2']) / 2).toStringAsFixed(1),
                        style: TextStyle(
