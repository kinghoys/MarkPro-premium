...
import 'package:markpro_plus/services/viva_import_service.dart';

class ImportVivaDialog extends StatefulWidget {
  final LabSession labSession;
  final Function onImportComplete;

  const ImportVivaDialog({
    Key? key,
  ...
  @override
  State<ImportVivaDialog> createState() => _ImportVivaDialogState();
}

class _ImportVivaDialogState extends State<ImportVivaDialog> {
  final VivaImportService _importService = VivaImportService();
                    ...
                    ElevatedButton(
                      onPressed: _isImporting
                          ...
                          : () async {
                              ...
                              try {
                                final importedMarks =
                                    await _importService.importVivaMarksFromExcel(context);
                    ...
                    ElevatedButton(
                      onPressed: _importedMarks.isEmpty || _isImporting
                          ...
                          : () async {
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 20),
                                          Text('Importing ${_importedMarks.length} Viva & Final marks...')
                                        ],
                                      ),
                                    ),
                                  );
                              ...
                              try {
                                await _importService.saveImportedVivaMarks(
                                    ...
                                    SnackBar(
                                      content: Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              'Successfully imported ${_importedMarks.length} Viva & Final marks',
        ...
        children: [
          ...
          _buildInstructionItem(
            ...
            subItems: [
              'Student ID (required)',
              'Name (required)',
              'Viva Marks (required, 0-20)',
              'Final Lab Grade (required, 0-50)',
            ],
          ),
          _buildInstructionItem(
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                ...
                const TextSpan(
                  text: 'Existing Viva and Final Lab Grade marks will be overwritten for the imported students.',
                ),
              ],
            ),
          ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      'Viva: ${mark['vivaMark']} | Final Grade: ${mark['finalGrade']}',
                    ),
                    leading: CircleAvatar(
                      backgroundColor: Colors.amber.shade100,
                      child: Text(
                        mark['finalGrade'].toString(),
                        style: TextStyle(
